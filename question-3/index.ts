...
let info = user_profile("HUMA MOHSIN", 32);
console.log(info);
...
(function () {
  ...
  //calling function
  displayUserProfile();
})(); //ends IIFE FUNCTION IMMEDIATELY AS IT INVOKES.It's a function that is defined and executed immediately after it's declared
